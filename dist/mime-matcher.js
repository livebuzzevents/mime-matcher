(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("mime-matcher", [], factory);
	else if(typeof exports === 'object')
		exports["mime-matcher"] = factory();
	else
		root["mime-matcher"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_array_from__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_slicedToArray__ = __webpack_require__(60);
...
function parse(mimeType) {
  ...
  var match = mimeType.match(MIME_TYPE_REGEX);
  var valid = Boolean(match);
  ...
  var _Array$from = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_array_from___default()(match),
      _Array$from2 = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_slicedToArray___default()(_Array$from, 4),
      type = _Array$from2[1],
      subType = _Array$from2[2],
      parameter = _Array$from2[3];
...
var MimeMatcher = function () {
  function MimeMatcher() {
    var _this = this;

    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, MimeMatcher);
    ...
    expected.forEach(function (mimeType) {
      var _parse = parse(mimeType),
          valid = _parse.valid,
          type = _parse.type,
          subType = _parse.subType;
      ...
      if (valid) {
        ...
        var msg = 'Value "' + mimeType + '" is not valid mime type.It should have format "type/subtype".';
        throw new TypeError(msg);
      }
    });
  }

  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(MimeMatcher, [{
    key: 'match',
    value: function match(actual) {
      var _parse2 = parse(actual),
          valid = _parse2.valid,
          type = _parse2.type,
          subType = _parse2.subType;

      if (valid) {
        return this.expected.some(function (_ref) {
          var typeMatcher = _ref.typeMatcher,
              subTypeMatcher = _ref.subTypeMatcher;
...
/* harmony default export */ __webpack_exports__["default"] = (MimeMatcher);
